...
// //             res.send("this account is deleted you can't log in , please create ew account")
// //         } else {
// //             next()
// //         }
// //     }
...
// //         res.send(
// //             "this user is deleted from our database you can't find")
...
// //     } else if (
// //         user.isDeleted == true) {
// //         res.send("this user  is deleted from our database you cant't post a message")
// //     } else {
...
// //         return res.send("No such user exists");
// //     } else if (user.isDeleted == true) {
// //         res.send("his account is already deleted, please create new account to delete")
// //     } else {
// //         let updatedPosts = await userModel.findByIdAndUpdate({ _id: userId }, { isdeleted: true }, { new: true })
// //         res.send({ status: true, dl: "user deleted successfully", data: updatedPosts });
// //     }
// // }
